...
//Particles
//--------------------------------------------------------------
Particle::Particle(const Domain2D& domain, const Coordinates& center, double r) : ls(), centroid(0, 0), centre(0, 0), vc(0, 0), w(0), nodes(0), ref_nodes(0), miu(0.26), k_n(1e5), k_s(1e5), force(0, 0), torque(0) {
...
Particle::Particle(const Polygon& poly, const Domain2D& domain) : ls(), centroid(0, 0), centre(0, 0), vc(0, 0), w(0), nodes(0), ref_nodes(0), miu(0.26), k_n(1e5), k_s(1e5), force(0, 0), torque(0) {
