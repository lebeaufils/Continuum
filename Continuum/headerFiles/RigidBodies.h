...
struct RigidBodies
{
	...
	static std::unordered_map<int, double>::iterator find_spring(std::unordered_map<int, double>, int);
	static void delete_spring(std::unordered_map<int, double>, int);
	static void contact_detection(const Domain2D&, Moving_RB&, double);
	static void wall_collision(double, vector2&, Particle&, const vector2&, double, const vector2&, double);
	static void particle_collision(double, vector2&, Particle&, Particle&, const vector2&, double, const vector2&, double);
	//
